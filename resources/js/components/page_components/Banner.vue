<template>
    <div class="default-tab">
          <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                      <a href="#General" class="ME-Tabs nav-link active" data-bs-toggle="tab">Upload Banner</a>
                  </li>
  ...
  const uploadImages = () => {
    ...
    axios.post('/api/upload_banner', formData, {
      headers: {
