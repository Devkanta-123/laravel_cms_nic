                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            <table class="table table-responsive-lg mb-0">
                                ...
                                <tbody>
                                    <template v-for="(menu, index) in sub_menus" :key="menu.id">
                                        <tr >
                                            <td>{{ index + 1 }}</td>
                                            <td>
                                                {{ menu.menu_name}}
                                            ...
                                            <td></td>
                                            <td class="">
                                                <a href="#" @click.prevent="editMenu(menu)" class="btn btn-primary shadow btn-xs  me-1"><i class="fas fa-pencil-alt"></i></a>
                                            </td>
                                        </tr> 
                                        <template v-if="menu.submenus && menu.submenus.length > 0">
                                            <template v-for="(subMenu) in menu.submenus" :key="subMenu.id">
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td class="">
                                                        <a href="#" @click.prevent="editMenu(subMenu)" class="btn btn-primary shadow btn-xs  me-1"><i class="fas fa-pencil-alt"></i></a>
                                                    </td>
                                                </tr>
                                                <template v-if="subMenu.submenus && subMenu.submenus.length > 0">
                                                    <template v-for="(thirdMenu) in subMenu.submenus" :key="thirdMenu.id">
                                                        <tr>
                                                            <td>{{ index + 1 }}</td>
                                                            <td style="padding-left: 40px;">{{ thirdMenu.menu_name }}</td>
                                                        </tr>
                                                    </template>
                                                </template>
                                            </template>
